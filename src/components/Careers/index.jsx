...
const Careers = ({ className }) => {
  ...
  const Career = ({ name, department, position, startDate, endDate, description, projects,details }) => (
    <Section className={styles.career}>
      ...
      <div className={`${projects ? styles.projects :styles.details}`}>{projects ? projects.map((project, index) => Project(project)) : details.map((detail, index) => ProjectWithoutDetail(detail))}</div>
    </Section>
  )
